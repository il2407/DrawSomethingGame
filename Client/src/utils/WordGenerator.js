...
function generateWordWithLength(length) {
  var rightSize = false;
  var wordUsed;
  while (!rightSize) {
    wordUsed = generateRandomWord();
    if (wordUsed.length === length) {
      rightSize = true;
    }
  }
  return wordUsed;
...
function generateWordWithRangeLength(minLength, maxLength) {
  var rightSize = false;
  var wordUsed;
  while (!rightSize) {
    wordUsed = generateRandomWord();
    if (wordUsed.length < maxLength + 1 && wordUsed.length > maxLength - 1) {
      rightSize = true;
    }
  }
  return wordUsed;
...
function generateWordWithMinLength(minLength) {
  var rightSize = false;
  var wordUsed;
  while (!rightSize) {
    wordUsed = generateRandomWord();
    if (wordUsed.length > minLength - 1) {
      rightSize = true;
    }
  }
  return wordUsed;
